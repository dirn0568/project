 ...
 * Generated at: 2022-10-10 13:20:58 UTC
...
public final class chat_005faddon_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write(" \r\n");
      out.write("<body>\r\n");
      out.write("    <!-- 로그인한 상태일 경우와 비로그인 상태일 경우의 chat_id설정 -->\r\n");
      out.write("    <c:if test=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${(login.id ne '') and !(empty login.id)}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\">\r\n");
      ...
      out.write("' id='chat_id' />\r\n");
      out.write("    </c:if>\r\n");
      out.write("    <c:if test=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${(login.id eq '') or (empty login.id)}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\">\r\n");
      out.write("        <input type=\"hidden\" value='");
      out.print(session.getId().substring(0, 6));
      out.write("'\r\n");
      out.write("            id='chat_id' />\r\n");
      out.write("    </c:if>\r\n");
      out.write("    <!--     채팅창 -->\r\n");
      out.write("    <div id=\"_chatbox\" style=\"display: none\">\r\n");
      out.write("        <fieldset>\r\n");
      out.write("            <div id=\"messageWindow\"></div>\r\n");
      out.write("            <br /> <input id=\"inputMessage\" type=\"text\" onkeyup=\"enterkey()\" />\r\n");
      out.write("            <input type=\"submit\" value=\"send\" onclick=\"send()\" />\r\n");
      out.write("        </fieldset>\r\n");
      out.write("    </div>\r\n");
      out.write("    <img class=\"chat\" src=\"./img/chat.png\" />\r\n");
      out.write("</body>\r\n");
      out.write("<!-- 말풍선아이콘 클릭시 채팅창 열고 닫기 -->\r\n");
      out.write("<script>\r\n");
      out.write("    $(\".chat\").on({\r\n");
      out.write("        \"click\" : function() {\r\n");
      out.write("            if ($(this).attr(\"src\") == \"./img/chat.png\") {\r\n");
      out.write("                $(\".chat\").attr(\"src\", \"./img/chathide.png\");\r\n");
      out.write("                $(\"#_chatbox\").css(\"display\", \"block\");\r\n");
      out.write("            } else if ($(this).attr(\"src\") == \"./img/chathide.png\") {\r\n");
      out.write("                $(\".chat\").attr(\"src\", \"./img/chat.png\");\r\n");
      out.write("                $(\"#_chatbox\").css(\"display\", \"none\");\r\n");
      out.write("            }\r\n");
      out.write("        }\r\n");
      out.write("    });\r\n");
      out.write("</script>\r\n");
      ...
      out.write("    var webSocket = new WebSocket('ws://localhost:8090/project0509Final/broadcasting');\r\n");
      ...
      out.write("                        + \"<p class='chat_content'><b class='impress'>\" + sender + \" : \" + content + \"</b></p>\");\r\n");
      out.write("                } else {\r\n");
      out.write("                    $(\"#messageWindow\").html($(\"#messageWindow\").html()\r\n");
      ...
      out.write("        } else {\r\n");
      out.write("            $(\"#messageWindow\").html($(\"#messageWindow\").html()\r\n");
      out.write("                + \"<p class='chat_content'>나 : \" + inputMessage.value + \"</p>\");\r\n");
      out.write("        }\r\n");
      out.write("        webSocket.send($(\"#chat_id\").val() + \"|\" + inputMessage.value);\r\n");
      ...
      out.write("        var elem = document.getElementById('messageWindow');\r\n");
